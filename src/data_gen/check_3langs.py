...
# goes with /data_3langs/ and tags_3langs.txt
...
# files in the data_3langs folder are of sizes
	...
	# 10k
	# 1k
# for the languages listed in tags_3langs.txt (3 languages per class)
...
def check_all():
    tags = open("/home/ekp/Documents/SBU_Fall2020/CSE538_NLP/Project/CSE538_FinalProject/tags_3langs.txt").readlines()
