...
# This script confirms that the 
	...
	#_Test2.txt
	#_Test3.txt
# files in the data_r folder are of sizes
	# 90k
	# 10k
	# 1k
# for the languages listed in tags.txt (4 languages per class)
...
def check(n):
    ...
    for x in lengths:
        ...
        try:
            dev = open(beginning+"data_r/" + x + "/"+n+"_Dev.txt").readlines(),
        except:
            dev = 'missing'
            
        try:
            train = open(beginning+"data_r/" + x + "/"+n+"_Training.txt").readlines(),
        except:
            train = 'missing'
            
        try:
            test1 = open(beginning+"data_r/" + x + "/"+n+"_Test1.txt").readlines(),
        except:
            test1 = 'missing'
            
        try:
            test2 = open(beginning+"data_r/" + x + "/"+n+"_Test2.txt").readlines(),
        except:
            test2 = 'missing'
            
        try:
            test3 = open(beginning+"data_r/" + x + "/"+n+"_Test3.txt").readlines(),
        except:
            test3 = 'missing'
